 ...
 *
 * <p>Copied into each app rather than shared, because these are separately built artifacts with no
 * code between them — the duplication is across an APK boundary, and the alternative is a library
 * neither app is big enough to want.
 *
...
final class Ui {
    ...
    static final int TINT_FILE = 0xFF64748B;
